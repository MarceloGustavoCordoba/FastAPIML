...
from procesos.asincronicas import carga_inicial,procesar_notificaciones
import asyncio
...
def iniciar_planificador():
    ...
    scheduler.add_job(ejecutar_tarea,CronTrigger(hour=20))
    scheduler.start()
...
@app.get('/')
def read_root():
    return "Proceso Completo hopla como andas ."
